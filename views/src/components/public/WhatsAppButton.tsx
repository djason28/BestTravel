...
export const WhatsAppButton: React.FC = () => {
  ...
  const defaultMessage = currentLang()==='zh' ? '你好！我对你们的旅行套餐感兴趣。' : 'Hello! I am interested in your travel packages.';
  ...
  return (
    <button
      ...
      aria-label={currentLang()==='zh' ? '通过微信联系我们' : 'Contact us on WhatsApp'}
    >
